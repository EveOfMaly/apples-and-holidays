...
def add_supply_to_winter_holidays(holiday_supplies, supply)
  ...
  holiday_supplies.each do |seasons, holidays_hash|
    if seasons == :winter 
...
def add_new_holiday_with_supplies(holiday_supplies, holidays, season, supplies)
  holiday_supplies[holidays][season] = supplies 
end
...
def all_supplies_in_holidays(holiday_supplies)
  ...
  holiday_supplies.each do |seasons, holidays_hash|
    ...
    holidays_hash.each do |season, supplies|
      new_season = []

      season.to_s.split("_").each do |word|
        new_season << word.capitalize
      end 
      puts "  #{new_season.join(" ")}: #{supplies.join(", ")}"
    end
  end
end
